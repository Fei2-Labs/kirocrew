...
class TestAcpBackendOverride:
    ...
    # opencode is upstream's harness now and IS served by the direct factory;
    # only this build's registry adapters degrade.
    @pytest.mark.parametrize("adapter", ["copilot"])
