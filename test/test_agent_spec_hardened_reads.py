...
_EXPECTED_CALL_SITE_LABELS: dict[str, list[tuple[str, str]]] = {
    ...
    "kiro_crew/acp/spec_agent_guard.py": [
        ("spec_agent_candidate_paths", "unknown"),
        ("spec_agent_shell_restriction", "unknown"),
    ],
    "kiro_crew/agent.py": [
    ...
    # Three reads, not upstream's one: this fork's context loader also hardens the
    # agent-prompt and agent-file-resource reads.
    "kiro_crew/context.py": [
        ("agent_file_resources", "unknown"),
        ("agent_prompt_load", "unknown"),
