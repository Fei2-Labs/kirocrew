...
| 6 selectability | Dormant by consequence, named in `acp_backends.NOT_SHIPPED_SELECTABLE` with Stage 5 as the reason (goose and pi sit there for the same reason). |
