...
PROBES: list[tuple[str, str, bool]] = [
    ...
    ("v4 outline-hidden suppresses too", '<input className="border outline-hidden" />', True),
    (
    ...
    (
        ...
        '<button className="px-2 focus:outline-hidden">x</button>',
        True,
    ),
    (
        "outline-hidden with a focus-visible cue passes",
        '<input className="outline-hidden focus-visible:border-accent" />',
        False,
    ),
    (
